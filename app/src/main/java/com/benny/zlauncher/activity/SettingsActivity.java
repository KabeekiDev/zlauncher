...
import com.benny.zlauncher.fragment.SettingsBaseFragment;
import com.benny.zlauncher.fragment.SettingsMasterFragment;
import com.benny.zlauncher.manager.Setup;
import com.benny.zlauncher.util.BackupHelper;
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case Definitions.INTENT_BACKUP:
                    BackupHelper.backupConfig(this, new File(Utils.getFileForUri(files.get(0)).getAbsolutePath() + "/zlauncher.zip").toString());
